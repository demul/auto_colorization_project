...
def split_into_stacks(x):
    ...
    x_vertical = tf.pad(x, paddings, 'CONSTANT') # [None, 57, 56, 64]
    x_horizontal = x # [None, 56, 56, 64]
...
class gated_conv_unit:
    ...
    def gated_conv(self, x_vertical, x_horizontal, isTrain,
        ...
        # x_vertical   : [None, 57, 56, 64]
        # x_horizontal : [None, 56, 56, 64]
